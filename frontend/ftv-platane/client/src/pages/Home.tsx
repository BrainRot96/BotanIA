...
import { AlertCircle, Leaf, TreeDeciduous } from "lucide-react";
...
export default function Home() {
  const [ftv, setFtv] = useState<FTV | null>(null);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    fetch("/platane_ftv.json")
      .then((res) => res.json())
      .then((data) => {
        setFtv(data);
        setLoading(false);
      ...
      .catch((err) => {
        console.error("Erreur lors du chargement de la FTV:", err);
        setLoading(false);
      });
  }, []);
  ...
  const data = ftv.fiche_technique;
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-base">{data.I_IDENTITE.cultivar}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <p>{data.II_CYCLE_DE_VIE.floraison_mois.join(", ")}</p>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                {(data.VI_SANTE_USAGES.toxique_humains || data.VI_SANTE_USAGES.toxique_animaux) && (
